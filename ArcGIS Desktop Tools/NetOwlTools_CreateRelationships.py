...
arcpy.management.AddFields(linktablename, [["LINKID", "TEXT", "LINKID", 50],  # NOQA
...
linkslinks = ["LINKID", "FROMID", "TOID", "FROMVALUE", "TOVALUE", "FROMROLE", "TOROLE", "FROMROLETYPE", "TOROLETYPE"]  # NOQA 
...
for lo in linkobjs:
    ...
    # tups = nof.create_dict_for_json(fieldobjs, linkslinks)
...
arcpy.management.AddFields(eventtablename, [["LINKID", "TEXT", "LINKID", 50],  # NOQA
                            ["FROMID", 'TEXT', "FROMID", 50],
                            ["TOID", 'TEXT', "TOID", 50],
                            ["FROMVALUE", 'TEXT', "FROMVALUE", 255],
                            ["TOVALUE", 'TEXT', "TOVALUE", 255],
...
eventsfields = ["LINKID", "FROMID", "TOID", "FROMVALUE", "TOVALUE", "FROMROLE", "TOROLE", "ORGDOC", "EVENTVALUE"]  # noqa: E501
...
nogeo = os.path.join(wk, "netowl_entities")
netowl_fc = os.path.join(wk, "netowl_output")
netowl_links = os.path.join(wk, "netowl_links")
netowl_events = os.path.join(wk, "netowl_events")

arcpy.CreateRelationshipClass_management(netowl_fc, netowl_links, os.path.join(wk, "FC_Links_To"), "SIMPLE", "netowl_fc", "netowl_links", "BOTH", "ONE_TO_MANY", "NONE", "UNIQUEID", "TOID")
arcpy.CreateRelationshipClass_management(netowl_fc, netowl_links, os.path.join(wk, "FC_Links_From"), "SIMPLE", "netowl_fc", "netowl_links", "BOTH", "ONE_TO_MANY", "NONE", "UNIQUEID", "FROMID")
arcpy.CreateRelationshipClass_management(netowl_fc, nogeo, os.path.join(wk, "FC_Entities"), "SIMPLE", "netowl_fc", "netowl_entities", "BOTH", "ONE_TO_MANY", "NONE", "ORGDOC", "ORGDOC")
arcpy.CreateRelationshipClass_management(netowl_fc, netowl_events, os.path.join(wk, "FC_Events_From"), "SIMPLE", "netowl_fc", "netowl_events", "BOTH", "ONE_TO_MANY", "NONE", "UNIQUEID", "FROMID")
arcpy.CreateRelationshipClass_management(netowl_fc, netowl_events, os.path.join(wk, "FC_Events_To"), "SIMPLE", "netowl_fc", "netowl_events", "BOTH", "ONE_TO_MANY", "NONE", "UNIQUEID", "TOID")
